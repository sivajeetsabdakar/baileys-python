...
def test_public_api_exports_core_building_blocks():
    ...
    assert callable(bpt.group_fetch_all_participating_node)
    assert callable(bpt.group_membership_requests_node)
    assert callable(bpt.group_membership_requests_update_node)
    assert callable(bpt.parse_group_participating)
    ...
    assert callable(bpt.community_fetch_all_participating_node)
    ...
    assert callable(bpt.parse_community_participating)
    ...
    assert hasattr(bpt.WhatsAppClient, "communityFetchAllParticipating")
    ...
    assert hasattr(bpt.WhatsAppClient, "groupFetchAllParticipating")
    assert hasattr(bpt.WhatsAppClient, "groupRequestParticipantsList")
    assert hasattr(bpt.WhatsAppClient, "groupRequestParticipantsUpdate")
